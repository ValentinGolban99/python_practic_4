...
# во втором — 4, в третьем — 6, далее — 8, 10, 12, 14, 16, 18 и 20. При этом коровы находятся не во всех стойлах. 
...
for i in range(1, 11):
    ...
    print(f"Стойло {i} свободно? Или занято?", end = '')
    stall = input(": ")
    
    if stall == 'a':
        result += 2 * i
        
print(f"Всего молока произведено: {result}")
